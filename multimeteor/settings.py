"""
Django settings for multimeteor project.
...
WSGI_APPLICATION = 'multimeteor.wsgi.application'
...
STATICFILES_STORAGE = 'multimeteor.storage.CompressedManifestStaticFilesStorage'
